        ...
        <div class="signup-form">
            <div class="signup-content">
                ...
                <form action="{{ route('create.user') }}" method="POST">
                    ...
                    <button type="submit">Sign Up <span class="material-symbols-outlined">
                            trending_flat
                        </span></button>
                </form>
                <div class="smalltext">Already have an account? <a href="{{ route('login.page') }}">Login here.</a></div>
            </div>
        </div>
    </div>
</body>
